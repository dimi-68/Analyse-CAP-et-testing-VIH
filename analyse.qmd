...
data_uni <-  basefr %>% 
  pivot_longer( cols =  c(score_connaissance_prevention,score_connaissance_transmission,score_connaissance_TME,score_connaissance_information), names_to = "type_score", values_to =  "scores")#reorganisationdu dataframe
